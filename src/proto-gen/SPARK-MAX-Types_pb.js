...
goog.exportSymbol('proto.sparkmax.DRVStat0_Bits', null, global);
goog.exportSymbol('proto.sparkmax.DRVStat1_Bits', null, global);
goog.exportSymbol('proto.sparkmax.configParam', null, global);
...
goog.exportSymbol('proto.sparkmax.idleMode', null, global);
goog.exportSymbol('proto.sparkmax.inputMode', null, global);
goog.exportSymbol('proto.sparkmax.motorType', null, global);
goog.exportSymbol('proto.sparkmax.paramStatus', null, global);
goog.exportSymbol('proto.sparkmax.paramType', null, global);
goog.exportSymbol('proto.sparkmax.sensorType', null, global);
/**
 * @enum {number}
 */
proto.sparkmax.motorType = {
  BRUSHED: 0,
  BRUSHLESS: 1
};
 ...
 * @enum {number}
 */
proto.sparkmax.definedFollowerID = {
  FOLLOWERDISABLED: 0,
  FOLLOWERCUSTOM: 25,
  FOLLOWERSPARKMAX: 26
};
 ...
 * @enum {number}
 */
proto.sparkmax.followerSignMode = {
  FOLLOWERNOSIGN: 0,
  FOLLOWERTWOSCOMP: 1,
  FOLLOWERSIGNMAG: 2
};
 ...
 * @enum {number}
 */
proto.sparkmax.configParamTypes = {
  KDEFAULT_T: 0,
  KCANID_T: 1,
  KINPUTMODE_T: 1,
  KMOTORTYPE_T: 1,
 ...
 * @enum {number}
 */
proto.sparkmax.configParamGroupName = {
  GROUPNAME_BASIC: 0,
 ...
 * @enum {number}
 */
proto.sparkmax.configParamGroup = {
  GROUP_DEFAULT: 0,
  GROUP_KCANID: 0,
  GROUP_KINPUTMODE: 0,
  GROUP_KMOTORTYPE: 0,
